...
}else{ // e가 20보다 크지도 않고, 작지도 않다면 20이다.
    console.log('e는 20이다')
}
/* if문의 특징: 단 한번만 실행 */
...
var e = '안녕'
console.log(e)
//var 이라는 변술를 선언하는 방식 - 중복선언이 가능
//이 변수명을 이미 사용중인지 아닌지 판단이 어렵다.
...
const bbb = '제이쿼리'
console.log(bbb)
///bbb = '안녕하세요22' - 처음에 선언했던 값 이외에 다른값 저장이 불가능 (상수)
...
/* 
    ...
    이런 구조이기 때문에 js가 불렸을 때에 html은 로딩되기 전임
